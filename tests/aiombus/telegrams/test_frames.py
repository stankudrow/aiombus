...
def test_short_frame_repr_str():
    ibytes = [SHORT_FRAME_START_BYTE, TelegramField(1), 2, 0b0000_0011, FRAME_STOP_BYTE]
...
def test_control_frame_init(data: Iterable, expectation: AbstractContextManager):
    with expectation:
