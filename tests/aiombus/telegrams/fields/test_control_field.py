...
def test_fcv_property(byte: int, answer: None | int, expectation: ContextManager):
    with expectation:
        cf = ControlField(byte)
...
def test_fcb_property(byte: int, answer: None | int, expectation: ContextManager):
    with expectation:
        cf = ControlField(byte)
...
def test_dfc_property(byte: int, answer: None | int, expectation: ContextManager):
    with expectation:
        cf = ControlField(byte)
...
def test_acd_property(byte: int, answer: None | int, expectation: ContextManager):
    with expectation:
        cf = ControlField(byte)
